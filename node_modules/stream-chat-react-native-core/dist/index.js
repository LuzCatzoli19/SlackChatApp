  ...
  _createClass(Gallery, [{
    ...
    value: function render() {
      ...
      if (images.length === 1) {
        ...
        }, additionalTouchableProps), React__default.createElement(reactNative.Image, {
          style: {
            width: 100 + '%',
            height: 100 + '%'
          },
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement(GalleryContainer, {
        ...
        }, additionalTouchableProps), i === 3 && images.length > 4 ? React__default.createElement(reactNative.View, {
          style: {
            width: '100%',
            height: '100%'
          }
...
var FileAttachment = withMessageContentContext(function (_ref8) {
  ...
  return React__default.createElement(reactNative.TouchableOpacity, _extends({
    onPress: function onPress() {
...
var LoadingErrorIndicator = function LoadingErrorIndicator(_ref4) {
  ...
  switch (listType) {
    case 'channel':
      Loader = React__default.createElement(Container$9, {
        onPress: function onPress() {
          retry && retry();
        }
      }, React__default.createElement(ErrorText, null, t('Error loading channel list ...')), React__default.createElement(RetryText, null, "\u27F3"));
      break;

    case 'message':
      Loader = React__default.createElement(Container$9, null, React__default.createElement(ErrorText, null, t('Error loading messages for this channel ...')));
      break;

    default:
      Loader = React__default.createElement(Container$9, null, React__default.createElement(ErrorText, null, t('Error loading')));
      break;
  }
...
var LoadingIndicator = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(LoadingIndicator, [{
    ...
    value: function render() {
      ...
      switch (listType) {
        case 'channel':
          return React__default.createElement(Container$a, null, React__default.createElement(Spinner, null), React__default.createElement(LoadingText, null, loadingText ? loadingText : t('Loading channels ...')));

        case 'message':
          return React__default.createElement(Container$a, null, React__default.createElement(Spinner, null), React__default.createElement(LoadingText, null, loadingText ? loadingText : t('Loading messages ...')));

        case 'default':
        default:
          return React__default.createElement(Container$a, null, React__default.createElement(Spinner, null), React__default.createElement(LoadingText, null, loadingText ? loadingText : t('Loading ...')));
      }
    }
  }]);
  ...
  _createClass(ReactionList, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(TouchableWrapper, {
        alignment: alignment,
        activeOpacity: 1
      }, React__default.createElement(Container$c, {
        visible: visible
...
var ReactionPicker = themed((_temp$b = _class$b = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(ReactionPicker, [{
    ...
    value: function render() {
      ...
      }, reactionPickerVisible && React__default.createElement(Container$e, {
        onPress: handleDismiss,
  ...
  _createClass(MessageContent, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(MessageContentContext.Provider, {
        value: context
      }, React__default.createElement(Container$f, _extends({}, contentProps, {
...
var TypingIndicator = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(TypingIndicator, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(Container$k, null, typingUsers.filter(function (_ref5) {
        var user = _ref5.user;
...
var ChannelListHeaderNetworkDownIndicator = withTranslationContext(function (_ref3) {
  var t = _ref3.t;
  return React__default.createElement(Container$p, null, React__default.createElement(ErrorText$1, null, t('Connection failure, reconnecting now ...')));
});
...
var ChannelListHeaderErrorIndicator = withTranslationContext(function (_ref3) {
  ...
  }, React__default.createElement(ErrorText$2, null, t('Error while loading, please reload/refresh')));
});
...
var ChannelListFooterLoadingIndicator = function ChannelListFooterLoadingIndicator() {
  return React__default.createElement(Container$r, null, React__default.createElement(Spinner, null));
};
  ...
  function ChannelListMessenger() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderHeaderIndicator", function () {
      ...
      if (!isOnline) {
        ...
        return React__default.createElement(HeaderNetworkDownIndicator, null);
      }

      if (error) {
        var HeaderErrorIndicator = _this.props.HeaderErrorIndicator;
        return React__default.createElement(HeaderErrorIndicator, {
          onPress: refreshList
        });
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderChannels", function () {
      return React__default.createElement(React__default.Fragment, null, _this.renderHeaderIndicator(), React__default.createElement(reactNative.FlatList, _extends({
        ...
        ListFooterComponent: function ListFooterComponent() {
          if (_this.props.loadingNextPage) {
            ...
            return React__default.createElement(FooterLoadingIndicator, null);
          }
...
var ChannelList = withChatContext((_temp$i = _class$i = /*#__PURE__*/function (_PureComponent) {
  ...
  function ChannelList(props) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                channelPromise = _this.props.client.queryChannels(filters, sort, options);
                _context.prev = 2;
                _context.next = 5;
    ...
    _defineProperty(_assertThisInitialized(_this), "getQueryParams", function (queryType) {
      ...
      var queryOptions = _objectSpread$a({}, options, {
        offset: offset,
        limit: limit
      });
    ...
    _this._queryChannelsDebounced = debounce( /*#__PURE__*/function () {
...
var IconBadge = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(IconBadge, [{
    ...
    value: function render() {
      ...
      return React.createElement(Container$s, null, children, unread > 0 && React.createElement(Icon$1, null, React.createElement(IconInner, null, showNumber && React.createElement(UnreadCount, null, unread))));
    }
  }]);
